...
export async function POST(request: NextRequest) {
  try {
    ...
    // Clear legacy cookies to prevent session conflicts
    response.cookies.set("auth_token_super", "", { path: "/", maxAge: 0 });
    response.cookies.set("auth_token_shop", "", { path: "/", maxAge: 0 });
