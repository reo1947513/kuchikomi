      ...
      <div className="max-w-lg mx-auto px-4 py-10 space-y-5">
        ...
        <div className="flex items-center gap-3">
          {data.logoUrl ? (
            ...
            <div
              className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 shadow bg-gradient-to-br from-cyan-500 to-violet-500"
            >
        ...
        <div className="space-y-3">
          {data.googleBusinessUrl && (
            <button
              ...
              className="flex items-center justify-center gap-2 w-full py-3.5 px-4 rounded-xl text-white text-sm font-bold shadow transition-opacity hover:opacity-90 bg-gradient-to-r from-cyan-500 to-violet-500 hover:from-cyan-600 hover:to-violet-600"
            >
