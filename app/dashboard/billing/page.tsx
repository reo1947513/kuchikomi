...
const subscriptionPlans: PlanCard[] = [
  {
    ...
    reviews: 50,
    priceId: "price_1TImxmEWf4VmtNG386asQ96L",
    mode: "subscription",
    planType: "standard",
  },
  {
    ...
    priceId: "price_1TKcMhEWf4VmtNG3y2KyadDT",
    mode: "subscription",
    planType: "premium",
  },
];
...
const additionalPacks = [
  {
    ...
    priceLabel: "¥2,000",
    reviews: 20,
    priceId: "price_1TImxlEWf4VmtNG3FlYOAGwV",
  ...
  },
  {
    ...
    priceLabel: "¥5,000",
    reviews: 50,
    priceId: "price_1TImxlEWf4VmtNG3WpPxutzB",
    mode: "payment" as const,
  },
];
