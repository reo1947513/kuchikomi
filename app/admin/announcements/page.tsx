      ...
      {lineModeModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-4">
            ...
            <p className="text-sm text-gray-500">全顧客へのメール送信と合わせて、LINE配信方法を選択してください。</p>
            <div className="space-y-2">
              <button onClick={() => handleSendWithMode(lineModeModal, "broadcast")}
                ...
                <div className="text-xs text-gray-500 mt-0.5">全顧客にメール送信＋公式LINE友だち全員にブロードキャスト</div>
              </button>
              <button onClick={() => handleSendWithMode(lineModeModal, "linked")}
                ...
                <div className="text-xs text-gray-500 mt-0.5">全顧客にメール送信＋LINE連携済みの顧客にのみLINE通知</div>
              </button>
              <button onClick={() => handleSendWithMode(lineModeModal, "none")}
                ...
                <div className="text-xs text-gray-500 mt-0.5">全顧客にメール配信のみ、LINE通知はスキップ</div>
              </button>
            </div>
