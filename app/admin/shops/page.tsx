              ...
              <tr key={shop.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-3 py-3">
                  <div className="flex items-center justify-end gap-2">
                    {shop.firstSurveyId && (
                      <button
                        onClick={() => window.open(`/dashboard/surveys/${shop.firstSurveyId}/settings`, '_blank')}
          ...
          return (
            <div key={shop.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
              ...
              <div className="flex flex-wrap gap-1.5">
                {shop.firstSurveyId && (
                  <button onClick={() => window.open(`/dashboard/surveys/${shop.firstSurveyId}/settings`, '_blank')}
              ...
              <div className="flex items-center gap-3 pt-2">
                {editingShop.firstSurveyId && (
                  <button
                    ...
                    onClick={() => {
                      setModalOpen(false);
                      window.open(`/dashboard/surveys/${editingShop.firstSurveyId}/settings`, '_blank');
                    }}
